...
<ul id="sidebarnav" class="p-t-30">
  <li class="sidebar-item"  v-for="(menu, index) in menus" v-bind:index="index" v-bind:key="menu.id">
    <a
      class="sidebar-link waves-effect waves-dark"
      aria-expanded="false"
      :class="{'has-arrow': menu.hasItem}"
      :href="menu.hasItem ? 'javascript:void(0)': menu.href "
    >
      <i class="mdi" :class="menu.mdi"></i>
      <span class="hide-menu">{{menu.text}}</span>
    </a>
    <ul aria-expanded="false" class="collapse first-level" v-if="menu.hasItem">
      <li class="sidebar-item" v-for="item in menu.items" v-bind:key="item.id">
        <a class="sidebar-link" :href="item.href">
          <i class="mdi"  :class="item.mdi"></i>
  ...
  <li class="sidebar-item">
    ...
    <ul aria-expanded="false" class="collapse first-level">
      <li class="sidebar-item">
        <a href="/form-basic" class="sidebar-link">
          <i class="mdi mdi-note-outline"></i>
          <span class="hide-menu">Form Basic</span>
        </a>
      </li>
      <li class="sidebar-item">
        <a href="/form-wizard" class="sidebar-link">
...
const menus = [
			{	
				...
				text: "111",
				hasItem: true,
				items: [{id:3,href: "index.html", mdi: "", text: "333"}]
			},
			{
				id:1,
				href: "index.html",
				...
				text: "222",
				hasItem: true,
				items: [{id:4,href: "index.html", mdi: "", text: "266"}]
			}
		]
module.exports = {
	data: function () {
